...
A minimal and productive task-tracking application built with Angular + Firebase.
Users can create, categorize, prioritize and manage tasks in real-time with smooth UI & authentication.
Designed for simplicity, responsiveness and daily workflow improvement.
## 🛠 Tech Stack
